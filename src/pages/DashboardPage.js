          ...
          <div className="dashboard-header">
            <div>
              ...
              <p className="dashboard-subtitle">
                Here’s a quick overview of what’s happening on your news
                platform today.
              </p>
            </div>
          </div>
            ...
            <div className="chart-header">
              <div>
                <h3 className="chart-title">
                  Traffic & Reads (Last 7 Days)
                </h3>
                <p className="chart-subtitle">
                  Dummy analytics data, similar to real news dashboards. We’ll
                  wire this to real analytics later.
                </p>
              </div>
            </div>
              ...
              <ResponsiveContainer width="100%" height={260}>
                ...
                >
                  ...
                  <Line
                    ...
                    dataKey="reads"
                    name="Reads"
                    stroke="#0e3d3b"        // 🌑 dark green from logo
                    strokeWidth={2}
                    dot={false}
                  />
                </LineChart>
